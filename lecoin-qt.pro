...
#   Bracket the code to profile with ProfileStart("lecoin-qt.prof") and ProfileStop() and recompile
#   Run Lecoin-qt through its paces then exit
#   Analyze with:
#      pprof ./lecoin-qt lecoin-qt.prof
#   For a graphical view you need to: sudo apt-get install graphviz gv
#   Then run:
#      pprof --gv ./lecoin-qt lecoin-qt.prof
PROFILE = 0
...
macx:ICON = src/qt/res/icons/lecoin.icns
macx:TARGET = "LeCoin-Qt"
