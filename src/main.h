...
inline bool PoSTprotocol(int nHeight) { return nHeight > 20; }
...
public:
    ...
    */
    ...
    bool GetStakeTime(CTxDB& txdb, uint64_t& nStakeTime, CBlockIndex* pindexPrev) const;  // LeCoin: get transaction staketime
