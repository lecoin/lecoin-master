...
/* Custom colors / fonts */
#define STR_COLOR QString("#3775B6")
#define STR_COLOR_LT QString("#3775B6")
#define STR_COLOR_HOVER QString("#3775B6")
#define STR_COLOR_TTBG QString("#e30011")
#define STR_FONT_COLOR QString("#E53C3C")
