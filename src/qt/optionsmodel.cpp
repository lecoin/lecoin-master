...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::LEC).toInt();
    nDecimalPoints = settings.value("nDecimalPoints", BitcoinUnits::decimals(BitcoinUnits::LEC)).toInt();
