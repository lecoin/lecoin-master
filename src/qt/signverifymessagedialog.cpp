    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("输入乐币地址（例如LTHZfUg11wEJmSgBLUcmCKGYekHFEdfjs）"));
    ui->signatureOut_SM->setPlaceholderText(tr("点击\“注册信息\”生成签名"));

    ui->addressIn_VM->setPlaceholderText(tr("输入乐币地址（例如LTHZfUg11wEJmSgBLUcmCKGYekHFEdfjs）"));
    ui->signatureIn_VM->setPlaceholderText(tr("进入乐币签名"));
#endif
