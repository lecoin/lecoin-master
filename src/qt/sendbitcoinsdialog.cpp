    ...
    model(0)
{
    ...
    ui->btnlecoin->setEnabled(true);

#if QT_VERSION >= 0x040700
    /* Do not move this to the XML file, Qt before 4.7 will choke on it */
    ui->lineEditCoinControlChange->setPlaceholderText(tr("输入乐点地址 (例如： LLRWAyE3WKwTzXszEmtqKXzikQvoq7NJBa)"));
#endif

    addEntry();

    connect(ui->btnlecoin, SIGNAL(clicked()), this, SLOT(gotoSendCoinsPage()));
...
void SendBitCoinsDialog::on_veriBitSendButton_clicked()
{
    ...
    {
        QMessageBox::warning(this, tr("乐点"),
            tr("Error: %1").
            arg("请等待钱包同步完成后使用乐点."),
    ...
    QUrl serviceUrl = QUrl("http://verisend.lecoin.info/apisendbtc");
    QByteArray postData;
...
void SendBitCoinsDialog::passResponse( QNetworkReply *finished )
{
    ...
    QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm VeriBit send of your LeCoins"),
