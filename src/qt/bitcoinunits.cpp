...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(LEC);
    unitlist.append(mLEC);
    unitlist.append(uLEC);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case LEC: return QString("LEC");
    case mLEC: return QString("mLEC");
    case uLEC: return QString::fromUtf8("μLEC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case LEC: return QString("LeCoins");
    case mLEC: return QString("Milli-LeCoins (1 / 1,000)");
    case uLEC: return QString("Micro-LeCoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case LEC:  return 100000000;
    case mLEC: return 100000;
    case uLEC: return 100;
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case LEC: return 8; // 21,000,000 (# digits, without commas)
    case mLEC: return 11; // 21,000,000,000
    case uLEC: return 14; // 21,000,000,000,000
    default: return 0;
    }
}
