...
// Copyright (c) 2013 The LeCoin developers
...
void StakeMiner(CWallet *pwallet)
{
    ...
    while (true)
    {
        ...
        while ((vNodes.size() < 1 && !fTestNet) || vNodes.size() < 1 || IsInitialBlockDownload() || nBestHeight < GetNumBlocksOfPeers())
        {
